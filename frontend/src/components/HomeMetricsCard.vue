  ...
  <div>
    <div class="flex flex-col gap-4">
      <div class="flex h-[42px] items-center justify-end">
        <button
          type="button"
          class="center-row h-[24px] w-[24px] justify-center rounded-[6px] border border-[#3b3b3b] bg-[#242424] text-[#9d9d9d] transition-colors duration-150 hover:border-[#4c4c4c] hover:text-white disabled:cursor-not-allowed disabled:opacity-60"
          :disabled="loading"
